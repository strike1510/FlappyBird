                ...
                for (int i = 0; i <= maxIndex; ++i)
                {
                    ...
                    switch (evt.type)
                    {
                        case EventType.Repaint:
                            ...
                            var visibilityState = GetVisibilityState(i);
                            ...
                            if (showIcon && (hover || !isItemVisible) && !isCreate)
                            {
                        ...
                        case EventType.MouseDown:
                            ...
                            if (evt.button == 0 && itemRect.Contains(evt.mousePosition)
                                                && (GetVisibilityState(i) != VisibilityState.NotVisible || (i == 0 && maxIndex == 0)))
                            {
                                GUIUtility.hotControl = itemControlID;
                                if (evt.clickCount == 1)
                                {
